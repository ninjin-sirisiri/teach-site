/**
 * Property Tests: Node.js入門レッスン
 * 
 * **Feature: nodejs-npm-lessons**
 * 
 * These tests verify the correctness properties defined in the design document
 * for the Node.js intro lesson.
 */
 ...
 */
describe('Property 1: Minimum Quiz Count - Node.js Intro', () => {
  const lesson = parseLessonFile('nodejs-intro.json');
 ...
 */
describe('Property 3: Required HTML Structure - Node.js Intro', () => {
  const lesson = parseLessonFile('nodejs-intro.json');
...
/**
 * Additional validation for Node.js intro lesson specific content
 */
describe('Node.js Intro Lesson Content Validation', () => {
  const lesson = parseLessonFile('nodejs-intro.json');

  it('should have correct id and category', () => {
    expect(lesson.id).toBe('nodejs-intro');
